...
<main class="main">
    <section class="welcome">
        <div class="container align-items-center">
            ...
            <img src="/public/img/home.png" class="welcome__img" alt="Умный дом">
        </div>
    </section>
        ...
        <section class="order">
            <div class="container">
                <img src="/public/img/доля_рынка.jpg" class="order__img">
        ...
        <div class="feedback">
            <div class="container">
                <img src="/public/img/feedback.png" class="feedback__img">

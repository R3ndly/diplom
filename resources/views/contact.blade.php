...
<div class="container">
    <div class="photo-grid">
        ...
        <div class="row mt-4"> 
            <div class="col">
                <div class="photo-item" style="background-image: url('{{ asset('img/byh.jpg') }}');">
                    <div class="overlay">
                        <h2 style="font-size: 16px;">Смирнова Валентина Витальевна</h2>
            ...
            <div class="col">
                <div class="photo-item" style="background-image: url('{{ asset('img/Дизайнер.webp') }}');">
                    <div class="overlay">
                        <h2 style="font-size: 17px;">Лебедев Александр Максимович</h2>
        ...
        <!-- Google карта -->
        <div class="about__map mt-4"> <!-- Добавляем отступ сверху -->
            ...
            <p class="map"><iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d78109.94496961955!2d104.26330920022136!3d52.28086785441388!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sru!2sru!4v1709458100782!5m2!1sru!2sru" width="1000" height="600" style="border:0;" allowfullscreen="" loading=“lazy” referrerpolicy=“no-referrer-when-downgrade”></iframe></p><br />

...
2. Просматривать список товаров, вакансий и сотрудников (т.е. реализована пагинация) и выполнять CRUD операции над ними; </br>
3. Добавлять товары в корзину и оформлять доставку, при этом товары из корзины удалятся; </br>
